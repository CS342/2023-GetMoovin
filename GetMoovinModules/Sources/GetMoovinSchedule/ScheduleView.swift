...
public struct ScheduleView: View {
    @EnvironmentObject var scheduler: GetMoovinScheduler
                ...
                GetMoovinScheduler(
                    tasks: [
                        Task(
                            ...
                            context: GetMoovinTaskContext.questionnaire(Bundle.main.questionnaire(withName: "SocialSupportQuestionnaire"))
                        )
                    ]
                )
            )
